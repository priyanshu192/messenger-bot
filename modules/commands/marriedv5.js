...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/EDm7mZJ.png", path);
}
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(210, 210), 1120, 440).composite(circleTwo.resize(200, 200), 2100, 790);
