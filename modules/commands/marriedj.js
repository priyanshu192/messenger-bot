...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/tYWDQwj.png", path);
}
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(170, 170), 905, 430).composite(circleTwo.resize(170, 170), 1320, 210);
