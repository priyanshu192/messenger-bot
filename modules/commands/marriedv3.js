...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/9f3Vki7.png", path);
}
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(80, 80), 400, 100).composite(circleTwo.resize(80, 80), 630, 150);
