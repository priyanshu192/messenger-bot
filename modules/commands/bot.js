...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "joya bhabhi") || (event.body.toLowerCase() == "alika bhabhi")) {
  ...
  if ((event.body.toLowerCase() == "joya") || (event.body.toLowerCase() == "alika") || (event.body.toLowerCase() == "who's joya") || (event.body.toLowerCase() == "joya kon hai") || (event.body.toLowerCase() == "alika kon hai") || (event.body.toLowerCase() == "alika kon h") || (event.body.toLowerCase() == "joya kon h")) {
     return api.sendMessage("Yes, She is my Owner bestfriend Jøya🥀✨", threadID);
   };
