...
console.log(chalk.bold.hex("#9900FF").bold("[ PriyanshBot Don't Change] » Warning For Changes"));
...
console.log(chalk.bold.hex("#00FFFF").bold("================== CONTACT TO PRIYANSH FOR KNOW HOW TO DO THIS ====================="));
